...
The performance data in Figure~\ref{designfig:1} is collected by TAU and SOSFlow infrastructure based on the information filtered by the prescriptive provenance module of Chimbuko. The data is temporary and will be flushed periodically to make room for the new data.
